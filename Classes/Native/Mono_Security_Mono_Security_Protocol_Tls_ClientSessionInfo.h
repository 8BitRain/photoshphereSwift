...
struct  ClientSessionInfo_t785  : public Object_t
{
	...
	ByteU5BU5D_t81* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t81* ___masterSecret_5;
};
struct ClientSessionInfo_t785_StaticFields{
